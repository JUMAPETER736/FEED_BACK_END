...
// OTP-BASED PASSWORD RESET ROUTES (for mobile app)
router.route("/forgot-password-otp").post(forgotPasswordRequestOTP);
router.route("/verify-otp").post(verifyResetOTP);
router.route("/reset-password-otp").post(resetPasswordWithOTP);

// TOKEN-BASED PASSWORD RESET ROUTES (for web/existing flows)
router
