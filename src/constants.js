...
export const MAXIMUM_SUB_IMAGE_COUNT = 8;
export const MAXIMUM_SOCIAL_POST_IMAGE_COUNT = 10;

export const DB_NAME = "flashapi";
...
export const NotificationEventEnum = {
  ...
  // Other notification events can be added here
};
...
export const ChatEventEnum = Object.freeze({
  ...
  // ? when receiver receives the message
  MESSAGE_DELIVERED_EVENT: "messageDelivered",
  //? when the receivers opens the message
  MESSAGE_SEEN_EVENT: "messageSeen",
  // ? when participant's last seen information is updated
  LAST_SEEN_EVENT: "lastSeen",
  //? when a participant in a group chat receives the message
  ACKNOWLEDGE_MESSAGE_EVENT: "messageAck",
  //? when a receiver downloads a message attachment
  ATTACHMENT_DOWNLOADED_EVENT: "downloaded",
});
